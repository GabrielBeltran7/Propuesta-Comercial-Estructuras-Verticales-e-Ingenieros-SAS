          ...
          <View style={styles.container}>
            ...
            <View style={{ marginTop: 12 }}>
              <Text>
                ...
                <Text style={styles.text}>{proposalData.executionPlace}</Text>
              </Text>
            </View>
          </View>
        </View>
          ...
          <View style={{ marginTop: 40 }}>
            ...
            <View style={{ marginTop: 12 }}>
              <Text>
                ...
                <Text style={styles.text}>
                  La empresa ESTRUCTURAS VERTICALES E INGENIEROS SAS, cuenta con
                  personal altamente calificado en reforzamiento, fabricación de
                  estructuras e impermeabilizaciones se encuentra con documentos
                  al día, certificado en trabajo en alturas, afiliados a ARP,
                  EPS, AFP y así se mantendrá durante la duración de la obra.
                </Text>
              </Text>
            </View>
            <View style={{ marginTop: 12 }}>
